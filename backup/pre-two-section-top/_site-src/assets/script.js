const languages = {
  ja: {
    ...
    text: {
      ...
      requirements_title: "購入前に確認", requirements_desc: "macOS、Linux、スマートフォンは公式サポート対象外です。", browser: "ブラウザ", chrome_latest: "Google Chrome 最新版", destination: "保存先", delivery: "提供物", privacy_title: "保存処理はPC内で完結", privacy_desc: "テレメトリや利用統計は収集しません。通信は、ユーザーが閲覧する対象ページへのアクセスと、明示的に指示した画像・動画の取得に限定されます。", privacy_note: "Obwriteは各サービスの公式製品ではありません。閲覧可能な単一ページを私的使用の範囲で保存するブラウジング支援ツールです。",
      blog_title: "Obwrite Blog", blog_desc: "動作条件、保存結果、設定、更新履歴を公開します。", blog_all: "すべての記事", pricing_desc: "Early Accessの買い切りダウンロード商品です。UIや補助機能は今後変更される場合があります。", one_time: "買い切り", pricing_buy: "BOOTHの商品説明を確認", footer_tagline: "Webの情報をローカルObsidian Vaultへ。", support: "サポート"
    }
  },
  en: {
